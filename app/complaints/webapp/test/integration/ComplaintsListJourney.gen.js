...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("ComplaintsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheComplaintsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheComplaintsListGenerated.onFilterBar().iChangeSearchField("Search Term");
